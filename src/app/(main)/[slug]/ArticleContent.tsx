        ...
        <article className="min-h-screen bg-background">
            ...
            <section className="w-full px-8 md:px-16 lg:px-24 -mt-16">
                <div className="max-w-5xl mx-auto">
                    <figure className="aspect-[16/9] relative rounded-lg overflow-hidden shadow-xl">
                        <Image
                            src={article.image}
                            alt={article.title}
                            fill
            ...
            <section className="py-16 md:py-24">
                <div className="w-full px-8 md:px-16 lg:px-24">
                    <div className="max-w-3xl mx-auto">
                        {article.content ? (
                            <div
                                className="prose prose-lg max-w-none text-foreground prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary prose-strong:text-foreground prose-li:text-muted-foreground"
