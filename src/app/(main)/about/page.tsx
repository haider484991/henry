                ...
                <div className="w-full px-8 md:px-16 lg:px-24">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg opacity-80 leading-relaxed mb-8">
                            Included in and in addition to his entrepreneurial pursuits, Henry has served as a strategic advisor, notably contributing to a solar energy company with aspirations to revolutionize global solar efficiency. His leadership acumen shines through his roles as a member and past President of the Entrepreneurs Organization (EO) Dallas Chapter and as a prior member of The Young Presidents Organization (YPO).
                        </p>
