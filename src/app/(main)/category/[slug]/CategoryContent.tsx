...
export function CategoryContent({ category, articles }: Props) {
    ...
    return (
        <div ref={pageRef} className="min-h-screen bg-background">
            {/* Hero Section */}
            <header className="relative py-32 md:py-40 bg-primary text-primary-foreground">
                        ...
                        <>
                            ...
                            <div className="news-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {articles.map((article) => (
                                    ...
                                    >
                                        <figure className="aspect-[16/10] bg-secondary mb-6 overflow-hidden relative">
                                            <Image
                                                src={article.image}
                                                alt={article.title}
                                                fill
                                        ...
                                        <div>
                                            ...
                                            <h2 className="text-lg font-medium text-foreground mb-3 group-hover:text-primary transition-colors line-clamp-2">
                                                {article.title}
                                            </h2>
